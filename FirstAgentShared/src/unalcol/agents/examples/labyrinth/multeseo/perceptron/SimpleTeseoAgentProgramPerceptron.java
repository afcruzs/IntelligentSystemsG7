package unalcol.agents.examples.labyrinth.multeseo.perceptron;
  ...
  public void init(){
   ...
   public void addToCmd(int d){
    ...
    public SimpleTeseoAgentProgramPerceptron(){
        ...
        //this.setLanguage(new SimpleLanguage(new String[]{"front", "right", "back", "left", "exit", "afront","aright","aback","aleft"},
    ...
    public int accion(boolean PF, boolean PD, boolean PA, boolean PI, boolean MT ) {
        ...
        if(actually.visited==false){
           ...
           if(actually.PF==false && sparceMatrix.existNode(xPosition, yPosition+1)==null){
            ...
            }else if(actually.PD==false && sparceMatrix.existNode(xPosition+1, yPosition)==null  ){
                ...
                //JOptionPane.showMessageDialog(null,actually.PF +" "+ actually.PD + " "+actually.PA +" "+ actually.PI);
                return mov;
            }else if(actually.PA==false && sparceMatrix.existNode(xPosition, yPosition-1)==null ){
                 ...
                 actually=temp;  
                 return mov;             
            }else if(actually.PI==false && sparceMatrix.existNode(xPosition-1, yPosition)==null){
